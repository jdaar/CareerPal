...
<div class="card-body pt-3">
	...
	{#if cachedRoleFormData !== null && cachedRoleFormData !== undefined}
		...
		<p>
			<span class="font-bold">Tags</span>: {cachedRoleFormData.tags.length > 0
				? cachedRoleFormData.tags.join(', ')
				: 'Por defecto'}
		</p>
	{:else}
	...
	{#if cachedParameterFormData !== null && cachedParameterFormData !== undefined}
		<p>
			<span class="font-bold">Texto de conexion</span>: {cachedParameterFormData.connection_string}
		</p>
