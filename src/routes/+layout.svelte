...
<div class="navbar bg-base-100 p-5">
	<div class="navbar-start">
		<a href="/" class="p-2">
			<svg width="50" height="41" viewBox="0 0 409 338" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<path fill-rule="evenodd" clip-rule="evenodd" d="M258 107H181V47H258C274.569 47 288 60.4315 288 77C288 93.5685 274.569 107 258 107ZM307 187H170L183.048 127H307C323.569 127 337 140.431 337 157C337 173.569 323.569 187 307 187Z" fill="#661AE6"/>
				<path fill-rule="evenodd" clip-rule="evenodd" d="M183 124C183 175.6 225.777 218 278.008 218C330.24 218 373.016 175.6 373.016 124C373.016 72.4003 330.24 30 278.008 30C225.777 30 183 72.4003 183 124ZM278.008 0C209.525 0 153 55.5167 153 124C153 192.483 209.525 248 278.008 248C346.491 248 403.016 192.483 403.016 124C403.016 55.5167 346.491 0 278.008 0Z" fill="#661AE6"/>
				...
				<path d="M360.888 323.664C367.329 335.876 382.451 340.554 394.664 334.112C406.876 327.671 411.554 312.549 405.112 300.336L360.888 323.664ZM312.888 232.664L360.888 323.664L405.112 300.336L357.112 209.336L312.888 232.664Z" fill="#661AE6"/>
			</svg>
		</a>
	</div>
